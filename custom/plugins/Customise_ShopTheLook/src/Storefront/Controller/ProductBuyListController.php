...
class ProductBuyListController extends StorefrontController
{
    ...
    /**
     * @HttpCache()
     * @Route("/custom-product-buy-list/{productId}/switch", name="custom.product.buy.list.switch", methods={"GET"}, defaults={"XmlHttpRequest"=true})
     */
    public function switch(string $productId, SalesChannelContext $salesChannelContext, Request $request): Response
    {
        ...
        return $this->renderStorefront('@Storefront/plugin/custom-shop-the-look/component/product-buy-list/product-item.html.twig', [
            'product' => $product,
            ...
            'enableVariantSwitch' => $request->query->getBoolean('enableVariantSwitch'),
        ]);
