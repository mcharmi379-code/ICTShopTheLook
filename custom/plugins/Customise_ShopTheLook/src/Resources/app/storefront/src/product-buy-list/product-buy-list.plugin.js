...
export default class CustomProductBuyListPlugin extends Plugin {
    static options = {
    ...
    init() {
        ...
        this._productListItems = this.el.querySelectorAll('[data-custom-product-buy-list-item]');
        this._buyButton = this.el.querySelector('[data-custom-product-buy-list-button]');
    ...
    _registerEvents() {
        ...
        this.el.addEventListener('change', event => {
            ...
            if (event.target.nodeName === 'INPUT') {
                const item = event.target.closest('[data-custom-product-buy-list-item]');
                ...
                const query = {
                    ...
                    enableVariantSwitch: that.options.enableVariantSwitch,
                };
