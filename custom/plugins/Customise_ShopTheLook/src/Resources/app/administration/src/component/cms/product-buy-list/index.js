...
Shopware.Service('cmsService').registerCmsElement({
    plugin: 'Customise_ShopTheLook',
    icon: 'default-shopping-cart',
    name: 'custom-product-buy-list',
    label: 'sw-cms.elements.custom-product-buy-list.name',
    component: 'sw-cms-el-custom-product-buy-list',
    previewComponent: 'sw-cms-el-preview-custom-product-buy-list',
    configComponent: 'sw-cms-el-config-custom-product-buy-list',
    defaultConfig: {
        layout: {
            source: 'static',
            value: 'default'
