...
import template from './sw-cms-el-custom-product-buy-list.html.twig';
import './sw-cms-el-custom-product-buy-list.scss';

Component.register('sw-cms-el-custom-product-buy-list', {
    template,
    ...
    methods: {
        createdComponent() {
            if (!Object.keys(this.element.config).length) {
                this.initElementConfig('custom-product-buy-list');
                this.initElementData('custom-product-buy-list');
            }
